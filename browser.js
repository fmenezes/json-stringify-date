...
exports.fnReplacer = fnReplacer;
exports.fnReviver = fnReviver;
...
function defaultFnCheck(key, value) {
  return typeof value === 'string' && (0, _moment.default)(value, _moment.default.ISO_8601, true).isValid() && value.length >= 6;
}
var options = {
  utc: false,
  fnCheck: defaultFnCheck,
  fnReplacerCheck: function fnReplacerCheck(key, value) {
...
function fnReplacer(replacer) {
  return function (key, value) {
    ...
    if (options.fnReplacerCheck(key, value)) {
      if (options.utc) {
        value = (0, _moment.default)(value).utc(false).format('YYYY-MM-DDTHH:mm:ss.SSS') + "Z";
      } else {
        value = (0, _moment.default)(value).format('YYYY-MM-DDTHH:mm:ss.SSSZ');
      }
    }
    return value;
  };
...
function setOptions(opt) {
  options = _objectSpread(_objectSpread({}, options), opt);
}
